...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tMinScore = new javax.swing.JTextField();
        cScore = new javax.swing.JCheckBox();
        ...
        tRegras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Corpo", "Cabeça", "Suporte", "Confiança", "Lift", "Rule Interest", "Convicção", "Added Value", "Odds Ratio", "Score"
            }
        ) {
        ...
        tMinScore.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        tMinScore.setText("0.0");
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(tMinScore, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(tMinScore, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cScore))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void bExportarCSVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExportarCSVActionPerformed
        ...
        try {
            ...
            out.write("Antecedente;Consequente;Suporte;Confiança;Lift;Rule Interest;Convicção;Score\n");
            //Fechando o arquivo
            out.close();
        } catch (Exception e) {
    ...
    private StringBuffer gerarConteudo(){
        ...
        saida.append("Antecedente;Consequente;Suporte;Confiança;Lift;Rule Interest;Convicção;Score\n");
    ...
    public DefaultTableModel gerarModeloTabela(ArrayList<Regra> regras){
        ...
        for(int linha=0;linha<regras.size();linha++){
            ...
            dados[9] = new Double(regras.get(linha).getEmsemble());
    ...
    public void definirConfiguracao(){
        ...
        configuracao.setScore(cScore.isSelected());
        ...
        configuracao.setScoreMin(Double.parseDouble(tMinScore.getText()));
    ...
    private javax.swing.JCheckBox cScore;
    ...
    private javax.swing.JTextField tMinScore;
