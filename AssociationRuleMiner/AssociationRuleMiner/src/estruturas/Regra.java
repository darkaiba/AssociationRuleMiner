...
public class Regra {
    ...
    double addedValue;
    double oddsRatio;
    //nova variavel criada
    double emsemble;
    
    //alteração para a nova variavel
    public Regra(){
        cabeca = "";
        corpo = "";
        suporte = 0;
    ...
    //alteração para a nova variavel
    public Regra(String corpo, String cabeca, double suporte, double confianca, double lift, double ri, double conviccao, double addedValue, double oddsRatio, double emsemble){
        this.corpo = corpo;
        this.cabeca = cabeca;
    ...
    //novos métodos que set e get para a nova variavel criada
    public double getEmsemble() {
        return emsemble;
    }

    public void setEmsemble(double emsemble) {
        this.emsemble = emsemble;
    }
